...
import { Bot, MessageSquare, Phone, Stethoscope, Users, Zap, ChevronRight, ArrowLeft } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Escolha o template ideal para seu agente de IA</p>
              </div>
            </div>
